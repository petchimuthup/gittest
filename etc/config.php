...
return [
    'modules' => [
        ...
        'ISN_CompanyExt' => 1,
        'ISN_EZGShippingGround' => 1,
        'Magento_Indexer' => 1,
        'ISN_Integration' => 1,
        'ISN_OrderHistory' => 1,
        'Magento_Config' => 1,
        'ISN_PurchaseOrderDetails' => 1,
        'ISN_PurchaseSummary' => 1,
        'ISN_Setup' => 0,
        'Magento_Customer' => 1,
        'Magento_Cms' => 1,
        'Magento_Quote' => 1,
        ...
        'Temando_Shipping' => 1,
        'Tychons_Favoriteorder' => 1,
        'Tychons_Page' => 1,
        'Tychons_Products' => 1,
        'Tychons_Quickrfq' => 1,
        'Tychons_Rushorder' => 1,
        'Tychons_Sorting' => 1,
        'Tychons_StoreManager' => 1,
        'Tychons_Storeorder' => 1,
        'Vertex_Tax' => 1
    ]
];
