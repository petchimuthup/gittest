    ...
    private function _migrateAttributeGroups($attributeGroups)
    {
        ...
        foreach ($attributeGroups as $attributeGroup) {
            ...
            if ($entityTypeCode1 == UBMigrate::PRODUCT_TYPE_CODE) {
                ...
                $found = Mage2AttributeGroup::model()->find("attribute_set_id = {$attributeSetId2} AND attribute_group_code = 'advanced-pricing'");
                $attributeGroupCode2 = (!$found && preg_match("/(prices)/i", $attributeGroupCode2)) ? 'advanced-pricing' : $attributeGroupCode2;
    ...
    private function _migrateAttributeSettings($attribute, $attribute2)
    {
        ...
        if ($entityTypeCode1 == UBMigrate::PRODUCT_TYPE_CODE) {
            ...
            if ($attributeSetting) {
                ...
                if (!$attributeSetting2 && !$attributeSetting->is_system) {
                    ...
                    //https://www.ubertheme.com/question/user-login-after-migration/
