...
<table class="table table-hover migrate-steps">
    <thead>
        <tr>
            ...
            <th class="migrate-steps-date-th"><?php echo Yii::t('frontend', 'Last Migration Date');?></th>
    ...
    <tbody>
        ...
        <tr class="step <?php echo $step->getStepStatusClassCSS(); ?>">
            ...
            <td id="step-last-migrated-time-<?php echo $step->sorder; ?>" style="text-align: left;">
                <?php
                    if ($step->sorder > 1) {
                        $lastMigrationTime = UBMigrate::getLastMigrationTime($step->sorder);
                        echo (!empty($lastMigrationTime)) ? Yii::app()->format->date(strtotime($lastMigrationTime)) : Yii::t('frontend', 'Not started yet.');
                    } else {
                        echo Yii::t('frontend', 'N/A');
                    }
                ?>
            </td>
