...
class Mage2SalesOrderGrid extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('store_name, order_currency_code, shipping_name, billing_name, billing_address, shipping_address,
			shipping_information, customer_email, customer_group, customer_name, payment_method', 'length', 'max'=>255),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('base_grand_total, base_total_paid, grand_total, total_paid, subtotal, shipping_and_handling, total_refunded', 'length', 'max'=>20),
