...
class Mage2SalesOrderAggregatedCreated extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('total_qty_ordered, total_qty_invoiced', 'length', 'max'=>12),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('total_income_amount, total_revenue_amount, total_profit_amount, total_invoiced_amount,
			total_canceled_amount, total_paid_amount, total_refunded_amount, total_tax_amount,total_tax_amount_actual,
			total_shipping_amount, total_shipping_amount_actual, total_discount_amount, total_discount_amount_actual', 'length', 'max'=>20),
			array('period', 'safe'),
		);
	}
