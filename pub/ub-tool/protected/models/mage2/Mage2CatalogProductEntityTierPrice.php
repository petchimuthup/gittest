 ...
 * @property string $percentage_value
 * @property integer $website_id
 */
class Mage2CatalogProductEntityTierPrice extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('percentage_value', 'length', 'max'=>5)
		);
	}
	 ...
	 * @return Mage2CatalogProductEntityTierPrice the static model class
	 */
