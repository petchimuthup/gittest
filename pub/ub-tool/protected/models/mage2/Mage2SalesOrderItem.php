...
class Mage2SalesOrderItem extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('store_id, is_virtual, is_qty_decimal, no_discount, locked_do_invoice, locked_do_ship, free_shipping,
			 gift_message_id, gift_message_available', 'numerical', 'integerOnly'=>true),
			...
			array('discount_percent, row_weight, tax_canceled', 'length', 'max'=>12),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('weight, qty_backordered, qty_canceled, qty_invoiced, qty_ordered, qty_refunded, qty_shipped, base_cost,
			 price, base_price, original_price, base_original_price, tax_percent, tax_amount, base_tax_amount, tax_invoiced,
			 base_tax_invoiced, discount_amount, base_discount_amount, discount_invoiced, base_discount_invoiced,
			 amount_refunded, base_amount_refunded, row_total, base_row_total, row_invoiced, base_row_invoiced,
			 base_tax_before_discount, tax_before_discount, price_incl_tax, base_price_incl_tax, row_total_incl_tax,
			 base_row_total_incl_tax, discount_tax_compensation_amount, base_discount_tax_compensation_amount,
			 discount_tax_compensation_invoiced, base_discount_tax_compensation_invoiced, discount_tax_compensation_refunded,
			 base_discount_tax_compensation_refunded, discount_tax_compensation_canceled, tax_refunded,
			 base_tax_refunded, discount_refunded, base_discount_refunded, weee_tax_applied_amount, weee_tax_applied_row_amount,
			 weee_tax_disposition, weee_tax_row_disposition, base_weee_tax_applied_amount, base_weee_tax_applied_row_amnt,
			 base_weee_tax_disposition, base_weee_tax_row_disposition', 'length', 'max'=>20),
