...
class Mage2SalesInvoiceItem extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('base_row_total, row_total', 'length', 'max'=>20),
			array('base_price, tax_amount, discount_amount, base_discount_amount,
			price_incl_tax, base_tax_amount, base_price_incl_tax, qty, base_cost, price, base_row_total_incl_tax,
			row_total_incl_tax, discount_tax_compensation_amount, base_discount_tax_compensation_amount,
			weee_tax_applied_amount, weee_tax_applied_row_amount, weee_tax_disposition, weee_tax_row_disposition,
			base_weee_tax_applied_amount, base_weee_tax_applied_row_amnt, base_weee_tax_disposition,
			base_weee_tax_row_disposition', 'length', 'max'=>12),
