 ...
 */
class Mage2SalesCreditmemo extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('store_id, email_sent, send_email, creditmemo_status, state, shipping_address_id, billing_address_id,
			invoice_id, customer_note_notify', 'numerical', 'integerOnly'=>true),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('adjustment_positive, base_shipping_tax_amount, store_to_order_rate, base_discount_amount,
			base_to_order_rate, grand_total, base_adjustment_negative, base_subtotal_incl_tax, shipping_amount,
			subtotal_incl_tax, adjustment_negative, base_shipping_amount, store_to_base_rate, base_to_global_rate,
			base_adjustment, base_subtotal, discount_amount, subtotal, adjustment, base_grand_total, base_adjustment_positive,
			base_tax_amount, shipping_tax_amount, tax_amount, discount_tax_compensation_amount, base_discount_tax_compensation_amount,
			shipping_discount_tax_compensation_amount, base_shipping_discount_tax_compensation_amnt, shipping_incl_tax,
			base_shipping_incl_tax', 'length', 'max'=>20),
	 ...
	 * @return Mage2SalesCreditmemo the static model class
	 */
