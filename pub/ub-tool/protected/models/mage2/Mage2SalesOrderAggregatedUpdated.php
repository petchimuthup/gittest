...
class Mage2SalesOrderAggregatedUpdated extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('total_income_amount, total_revenue_amount, total_profit_amount,
			total_invoiced_amount, total_canceled_amount, total_paid_amount, total_refunded_amount, total_tax_amount,
			total_tax_amount_actual, total_shipping_amount, total_shipping_amount_actual, total_discount_amount,
			total_discount_amount_actual', 'length', 'max'=>20),
			array('period', 'safe'),
		);
	}
