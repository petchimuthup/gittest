...
class Mage2SalesInvoice extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('store_id, billing_address_id, is_used_for_refund, email_sent, send_email, can_void_flag, state,
			shipping_address_id, customer_note_notify', 'numerical', 'integerOnly'=>true),
			array('total_qty', 'length', 'max'=>12),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('base_grand_total, shipping_tax_amount, tax_amount, base_tax_amount, store_to_order_rate,
			base_shipping_tax_amount, base_discount_amount, base_to_order_rate, grand_total, shipping_amount,
			subtotal_incl_tax, base_subtotal_incl_tax, store_to_base_rate, base_shipping_amount,
			base_to_global_rate, subtotal, base_subtotal, discount_amount, discount_tax_compensation_amount,
			base_discount_tax_compensation_amount, shipping_discount_tax_compensation_amount,
			base_shipping_discount_tax_compensation_amnt, shipping_incl_tax, base_shipping_incl_tax, base_total_refunded', 'length', 'max'=>20),
