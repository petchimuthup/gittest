...
class Mage2SalesQuoteAddressItem extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('parent_item_id, quote_address_id, quote_item_id, product_id, super_product_id, parent_product_id,
			is_qty_decimal, no_discount', 'length', 'max'=>10),
			array('weight, qty, row_weight, price, discount_percent, tax_percent, base_price, base_cost', 'length', 'max'=>12),
			// rules applied from M2.3.1: changed max length allowed from 12 to 20
			array('discount_amount, tax_amount, row_total, base_row_total, row_total_with_discount,
				base_discount_amount, base_tax_amount, price_incl_tax, base_price_incl_tax, row_total_incl_tax,
				discount_tax_compensation_amount, base_discount_tax_compensation_amount, base_row_total_incl_tax', 'length', 'max'=>20),
