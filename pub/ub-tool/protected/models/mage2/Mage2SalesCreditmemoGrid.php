 ...
 */
class Mage2SalesCreditmemoGrid extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('base_grand_total, subtotal, shipping_and_handling, adjustment_positive, adjustment_negative,order_base_grand_total', 'length', 'max'=>20),
	 ...
	 * @return Mage2SalesCreditmemoGrid the static model class
	 */
