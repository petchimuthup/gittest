	...
	public function rules()
	{
		...
		return array(
			...
			array( 'weight, qty, price, base_price, custom_price, discount_percent,
			 	tax_percent, row_weight, original_custom_price, base_cost, weee_tax_applied_amount, weee_tax_applied_row_amount,
			...
			array('discount_amount, base_discount_amount, tax_amount, base_tax_amount, row_total, base_row_total,
				row_total_with_discount, base_tax_before_discount, tax_before_discount, price_incl_tax, base_price_incl_tax,
				row_total_incl_tax, base_row_total_incl_tax, discount_tax_compensation_amount, base_discount_tax_compensation_amount', 'length', 'max'=>12),
		);
	}
