...
class Mage2SalesQuoteAddress extends Mage2ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('save_in_address_book, same_as_billing, collect_shipping_rates, free_shipping, vat_is_valid,
			vat_request_success, gift_message_id', 'numerical', 'integerOnly'=>true),
			array('quote_id, customer_id, customer_address_id, address_type, region_id', 'length', 'max'=>10),
			array('firstname, lastname, email, company, street, city, region, telephone, fax, shipping_description,
			discount_description', 'length', 'max'=>255),
			array('middlename, prefix, suffix', 'length', 'max'=>40),
			//rules applied from Magento ver.2.2.0
			...
			array( 'subtotal, base_subtotal, subtotal_with_discount, base_subtotal_with_discount, tax_amount, base_tax_amount,
				shipping_amount, base_shipping_amount, shipping_tax_amount, base_shipping_tax_amount, discount_amount,
				base_discount_amount, grand_total, base_grand_total, shipping_discount_amount, base_shipping_discount_amount,
				subtotal_incl_tax, base_subtotal_total_incl_tax, discount_tax_compensation_amount, base_discount_tax_compensation_amount,
