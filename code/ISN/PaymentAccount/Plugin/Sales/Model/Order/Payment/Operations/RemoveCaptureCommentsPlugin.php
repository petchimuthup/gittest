...
namespace ISN\PaymentAccount\Plugin\Sales\Model\Order\Payment\Operations;

/**
 * Remove capture comments for 'accountpayment' payment method.
 */
class RemoveCaptureCommentsPlugin
{
    /**
     * Remove capture comments if payment method is 'accountpayment'.
     *
     * Capture operation adds comments to order. But we must not save those comments for 'accountpayment' payment method.
    ...
    public function aroundCapture(
        ...
        if (\ISN\PaymentAccount\Model\AccountPaymentPaymentConfigProvider::METHOD_NAME == $payment->getMethod()) {
            /**
