 ...
 */
namespace ISN\PaymentAccount\Model\Config;
...
class EmailTemplate
{
     ...
     * @var string
     */
    private $accountPaymentChangeSender = 'company/email/company_credit_change';

    /**
     * @var string
     */
    private $accountPaymentCreateCopyMethod = 'company/email/company_credit_copy_method';
    ...
    public function getSenderByStoreId($storeId)
    {
        return $this->scopeConfig->getValue(
            $this->accountPaymentChangeSender,
    ...
    public function getCreditCreateCopyMethod(
        ...
        return $this->scopeConfig->getValue($this->accountPaymentCreateCopyMethod, $scopeType, $scopeCode);
    }
