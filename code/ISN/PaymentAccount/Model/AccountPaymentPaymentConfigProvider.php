 ...
 */
class AccountPaymentPaymentConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
    /**
     * Name for payment method.
     */
    const METHOD_NAME = 'accountpayment';
    ...
    /**
     * AccountPaymentPaymentConfigProvider constructor.
     *
