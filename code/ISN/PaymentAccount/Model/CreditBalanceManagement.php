...
class CreditBalanceManagement implements CreditBalanceManagementInterface
{
    ...
    public function decrease(
        ...
        $operationType,
        $comment = '',
        \ISN\PaymentAccount\Api\Data\CreditBalanceOptionsInterface $options = null
    ) {
     ...
     * @param int $status
     * @param \ISN\PaymentAccount\Api\Data\CreditBalanceOptionsInterface|null $options [optional]
     * @return void
     * @throws \Exception
     */
