...
class History extends AbstractModel implements HistoryInterface
{
    ...
    {
        $this->_init(\ISN\PaymentAccount\Model\ResourceModel\History::class);
    }
     ...
     * {@inheritdoc}
     */
    public function getAccountPaymentId()
    {
     ...
     * {@inheritdoc}
     */
    public function setAccountPaymentId($accountPaymentId)
    {
        return $this->setData(self::COMPANY_CREDIT_ID, $accountPaymentId);
    }
