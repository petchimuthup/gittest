...
class CreditBalanceManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\CreditBalanceManagement
     */
    ...
    protected function setUp()
    {
        ...
        $this->historyCollectionFactoryMock = $this->getMockBuilder(HistoryCollectionFactory::class)
            ...
            ->setMethods(['create'])
            ->getMock();
        $this->websiteCurrencyMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\WebsiteCurrency::class)
            ->disableOriginalConstructor()
            ->getMock();

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->creditBalanceManagement = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditBalanceManagement::class,
            [
    ...
    public function testDecrease()
    {
        $data = [
            'balanceId' => 1,
            'status' =>  \ISN\PaymentAccount\Model\HistoryInterface::TYPE_PURCHASED,
            'amount' => 10,
            'currency' => 'USD',
        ...
        $options = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditBalanceOptions::class)
            ->disableOriginalConstructor()
            ->setMethods(['getData'])
            ->getMock();
        ...
        $credit = $this->getMockBuilder(\ISN\PaymentAccount\Api\Data\CreditLimitInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testIncrease()
    {
        $data = [
            'balanceId' => 1,
            'status' =>  \ISN\PaymentAccount\Model\HistoryInterface::TYPE_REFUNDED,
            'amount' => 10,
            'currency' => 'USD',
            'comment' => 'Some comment',
            'orderNumber' => '00001',
    ...
    public function testIncreaseWithAllocatedStatus()
    {
        $data = [
            'balanceId' => 1,
            'status' =>  \ISN\PaymentAccount\Model\HistoryInterface::TYPE_ALLOCATED,
            'amount' => 10,
            'currency' => 'USD',
            'comment' => 'Some comment',
            'orderNumber' => '00001',
        ...
        $creditMock = $this->getMockBuilder(\ISN\PaymentAccount\Api\Data\CreditLimitInterface::class)
            ->disableOriginalConstructor()
    ...
    public function testIncreaseWithException()
    {
        ...
        $this->creditBalanceManagement->increase(
            ...
            10,
            null,
            \ISN\PaymentAccount\Model\HistoryInterface::TYPE_ALLOCATED,
            null,
            null
        );
    }
