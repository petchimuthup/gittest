...
namespace ISN\PaymentAccount\Test\Unit\Model\CreditLimit;

/**
 * Unit tests for \ISN\PaymentAccount\Model\CreditLimit\SearchProvider model.
 *
...
{
    /**
     * @var \ISN\PaymentAccount\Model\ResourceModel\CreditLimit\CollectionFactory
    ...
    protected function setUp()
    {
        $this->creditLimitCollectionFactory =
            $this->getMockBuilder(\ISN\PaymentAccount\Model\ResourceModel\CreditLimit\CollectionFactory::class)
        ...
        $this->searchProvider = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditLimit\SearchProvider::class,
            [
    ...
    {
        $filterField = \ISN\PaymentAccount\Api\Data\CreditLimitInterface::COMPANY_ID;
        $filterValue = 3;
        $conditionType = 'neq';
        $collectionSize = 1;
        $sortOrderField = \ISN\PaymentAccount\Api\Data\CreditLimitInterface::BALANCE;
        ...
        $collection = $this->getMockBuilder(\ISN\PaymentAccount\Model\ResourceModel\CreditLimit\Collection::class)
            ->disableOriginalConstructor()
            ->getMock();
