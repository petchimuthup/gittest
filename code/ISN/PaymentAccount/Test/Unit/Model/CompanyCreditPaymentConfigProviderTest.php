...
/**
 * Class AccountPaymentPaymentConfigProviderTest.
 *
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class AccountPaymentPaymentConfigProviderTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    /**
     * @var \ISN\PaymentAccount\Model\CreditCheckoutData|\PHPUnit_Framework_MockObject_MockObject
     */
    private $creditCheckoutData;

    /**
     * @var \ISN\PaymentAccount\Model\AccountPaymentPaymentConfigProvider
     */
    ...
    protected function setUp()
    {
        ...
        $this->creditCheckoutData = $this->createMock(
            \ISN\PaymentAccount\Model\CreditCheckoutData::class
        );

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->configProvider = $objectManager->getObject(
            \ISN\PaymentAccount\Model\AccountPaymentPaymentConfigProvider::class,
            [
