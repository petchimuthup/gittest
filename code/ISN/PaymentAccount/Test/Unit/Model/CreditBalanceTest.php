...
use ISN\PaymentAccount\Model\CreditBalanceOptionsFactory;
...
class CreditBalanceTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\CompanyStatus|\PHPUnit_Framework_MockObject_MockObject
     */
    private $companyStatus;

    /**
     * @var \ISN\PaymentAccount\Api\CreditBalanceManagementInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    private $creditBalanceManagement;

    /**
     * @var \ISN\PaymentAccount\Model\CompanyOrder|\PHPUnit_Framework_MockObject_MockObject
     */
    private $companyOrder;

    /**
     * @var \ISN\PaymentAccount\Model\CreditBalanceOptionsFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->companyStatus = $this->createMock(
            \ISN\PaymentAccount\Model\CompanyStatus::class
        );
        $this->creditBalanceManagement = $this->createMock(
            \ISN\PaymentAccount\Api\CreditBalanceManagementInterface::class
        );
        $this->companyOrder = $this->createMock(
            \ISN\PaymentAccount\Model\CompanyOrder::class
        );
        ...
        $this->creditBalance = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditBalance::class,
            [
    ...
    public function testDecreaseBalanceByOrder()
    {
        ...
        $creditBalanceOptions = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditBalanceOptions::class)
            ->disableOriginalConstructor()
            ->getMock();
