...
namespace ISN\PaymentAccount\Test\Unit\Model\Payment\Checks;
...
class HasCompanyPermissionTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\Payment\Checks\HasCompanyPermission
     */
    ...
    protected function setUp()
    {
        ...
        $this->hasCompanyPermission = $objectManager->getObject(
            \ISN\PaymentAccount\Model\Payment\Checks\HasCompanyPermission::class,
            [
    ...
    public function testIsApplicableWithPaymentOnAccountMethod()
    {
        ...
        $paymentMethod->expects($this->once())->method('getCode')->willReturn(
            \ISN\PaymentAccount\Model\Payment\Checks\HasCompanyPermission::PAYMENT_ACCOUNT_METHOD_CODE
        );
