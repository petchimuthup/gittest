...
class CreditCurrencyHistoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->creditCurrencyHistory = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditCurrencyHistory::class,
            [
    ...
    public function testUpdate()
    {
        ...
        $this->searchCriteriaBuilder->expects($this->once())->method('addFilter')
            ->with(\ISN\PaymentAccount\Model\HistoryInterface::COMPANY_CREDIT_ID, $currentId)->willReturnSelf();
        ...
        $historyItem = $this->createMock(\ISN\PaymentAccount\Model\History::class);
        ...
        $historyItem->expects($this->once())->method('setAccountPaymentId')->with($newId)->willReturnSelf();
