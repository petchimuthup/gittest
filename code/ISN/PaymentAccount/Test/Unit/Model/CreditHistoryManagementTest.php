...
use ISN\PaymentAccount\Model\ResourceModel\History\Collection as HistoryCollection;
...
class CreditHistoryManagementTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\CreditHistoryManagement
     */
    private $creditHistoryManagement;

    /**
     * @var \ISN\PaymentAccount\Model\ResourceModel\History|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->historyResourceMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\ResourceModel\History::class)
        ...
        $this->historyRepositoryMock = $this
            ->getMockBuilder(\ISN\PaymentAccount\Model\HistoryRepositoryInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->creditHistoryManagement = $this->objectManagerHelper->getObject(
            \ISN\PaymentAccount\Model\CreditHistoryManagement::class,
            [
    ...
    public function testUpdate()
    {
        ...
        $history = $this->getMockBuilder(\ISN\PaymentAccount\Model\History::class)
        ...
        $history->expects($this->once())->method('getType')
            ->willReturn(\ISN\PaymentAccount\Model\HistoryInterface::TYPE_REIMBURSED);
    ...
    public function testUpdateWithWrongType()
    {
        ...
        $this->historyRepositoryMock->expects($this->once())->method('get')->with($historyId)->willReturn($history);
        $history->expects($this->once())->method('getType')
            ->willReturn(\ISN\PaymentAccount\Model\HistoryInterface::TYPE_ALLOCATED);
        $this->creditHistoryManagement->update($historyId);
    }
    ...
    public function testGetList()
    {
        ...
        $collection = $this->getMockBuilder(\ISN\PaymentAccount\Model\ResourceModel\History\Collection::class)
            ->disableOriginalConstructor()->getMock();
        ...
        $history = $this->getMockBuilder(\ISN\PaymentAccount\Model\HistoryInterface::class)
            ->disableOriginalConstructor()->getMock();
