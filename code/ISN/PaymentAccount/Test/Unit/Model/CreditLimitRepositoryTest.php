...
class CreditLimitRepositoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\Validator|\PHPUnit_Framework_MockObject_MockObject
     */
    private $validatorMock;

    /**
     * @var \ISN\PaymentAccount\Model\SaveHandler|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \ISN\PaymentAccount\Model\CreditLimitRepository
     */
    ...
    protected function setUp()
    {
        ...
        $this->creditLimitResource =
            $this->getMockBuilder(\ISN\PaymentAccount\Model\ResourceModel\CreditLimit::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->validatorMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\Validator::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->saveHandlerMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\SaveHandler::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->searchProvider = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditLimit\SearchProvider::class)
            ->disableOriginalConstructor()
            ->getMock();

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->creditLimitRepository = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditLimitRepository::class,
            [
    ...
    {
        $creditLimitId = 1;
        $creditLimitMock = $this->getMockBuilder(\ISN\PaymentAccount\Api\Data\CreditLimitInterface::class)
            ->disableOriginalConstructor()
            ->setMethods(['getData', 'getId', 'getCompanyId', 'getCurrencyCode'])
            ->getMockForAbstractClass();
        $creditLimitData = [\ISN\PaymentAccount\Api\Data\CreditLimitInterface::CURRENCY_CODE => 'USD'];
    ...
    {
        $companyId = 2;
        $originalCreditLimitMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditLimit::class)
            ->disableOriginalConstructor()
            ->setMethods(['getData', 'getId', 'getCompanyId', 'getCurrencyCode'])
            ->getMockForAbstractClass();
        ...
        $this->validatorMock->expects($this->once())->method('checkAccountPaymentExist')
    ...
    public function testGetList()
    {
        $searchCriteria = $this->getMockBuilder(\Magento\Framework\Api\Search\SearchCriteriaInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $searchResults = $this->getMockBuilder(\ISN\PaymentAccount\Api\Data\CreditLimitSearchResultsInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
