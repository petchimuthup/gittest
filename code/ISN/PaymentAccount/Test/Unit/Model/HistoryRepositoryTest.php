...
class HistoryRepositoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\HistorySearchResultsInterfaceFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    private $searchResultsFactory;

    /**
     * @var \ISN\PaymentAccount\Model\Email\Sender|\PHPUnit_Framework_MockObject_MockObject
     */
    private $emailSender;

    /**
     * @var \ISN\PaymentAccount\Model\HistoryRepository
     */
    ...
    protected function setUp()
    {
        ...
        $this->historyRepository = $objectManager->getObject(
            \ISN\PaymentAccount\Model\HistoryRepository::class,
            [
    ...
    {
        $filterField = \ISN\PaymentAccount\Model\HistoryInterface::TYPE;
        $filterValue = \ISN\PaymentAccount\Model\HistoryInterface::TYPE_REIMBURSED;
        $conditionType = 'neq';
        $collectionSize = 1;
        $sortOrderField = \ISN\PaymentAccount\Model\HistoryInterface::DATETIME;
        ...
        $creditLimit = $this->createMock(\ISN\PaymentAccount\Model\CreditLimit::class);
