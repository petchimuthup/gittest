...
use ISN\PaymentAccount\Model\CreditLimit;
...
class CreditLimitHistoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\Creator|\PHPUnit_Framework_MockObject_MockObject
     */
    private $creator;

    /**
     * @var \ISN\PaymentAccount\Model\HistoryHydrator|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->historyRepository = $this->getMockBuilder(\ISN\PaymentAccount\Model\HistoryRepositoryInterface::class)
            ->disableOriginalConstructor()->getMock();
        $this->historyFactory = $this->getMockBuilder(\ISN\PaymentAccount\Model\HistoryFactory::class)
            ->setMethods(['create'])
            ->disableOriginalConstructor()->getMock();
        ...
        $this->companyRepository = $this->getMockBuilder(\Magento\Company\Api\CompanyRepositoryInterface::class)
            ->disableOriginalConstructor()->getMock();
        $this->creator = $this->getMockBuilder(\ISN\PaymentAccount\Model\Creator::class)
            ->disableOriginalConstructor()->getMock();
        $this->historyHydrator = $this->getMockBuilder(\ISN\PaymentAccount\Model\HistoryHydrator::class)
            ->disableOriginalConstructor()->getMock();

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->creditLimitHistory = $objectManager->getObject(
            \ISN\PaymentAccount\Model\CreditLimitHistory::class,
            [
