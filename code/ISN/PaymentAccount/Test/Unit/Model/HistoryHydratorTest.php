...
class HistoryHydratorTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\HistoryHydrator
     */
    ...
    protected function setUp()
    {
        ...
        $this->historyHydrator = $objectManager->getObject(
            \ISN\PaymentAccount\Model\HistoryHydrator::class,
            [
    ...
    public function testHydrate(
        ...
        $this->objectHelper->expects($this->once())->method('populateWithArray')
            ->with($history, $data['options']->getData(), \ISN\PaymentAccount\Model\HistoryInterface::class)
            ->willReturnSelf();
        $history->expects($this->once())->method('unsetData')
            ->with(\ISN\PaymentAccount\Model\HistoryInterface::HISTORY_ID)->willReturnSelf();
        $history->expects($this->once())->method('setAccountPaymentId')->with($creditId)->willReturnSelf();
