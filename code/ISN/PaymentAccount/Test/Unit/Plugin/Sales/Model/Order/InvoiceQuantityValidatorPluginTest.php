...
namespace ISN\PaymentAccount\Test\Unit\Plugin\Sales\Model\Order;
...
{
    /**
     * @var \ISN\PaymentAccount\Plugin\Sales\Model\Order\InvoiceQuantityValidatorPlugin
     */
    ...
    protected function setUp()
    {
        ...
        $this->invoiceQuantityValidatorPlugin = $objectManager->getObject(
            \ISN\PaymentAccount\Plugin\Sales\Model\Order\InvoiceQuantityValidatorPlugin::class
        );
    }
