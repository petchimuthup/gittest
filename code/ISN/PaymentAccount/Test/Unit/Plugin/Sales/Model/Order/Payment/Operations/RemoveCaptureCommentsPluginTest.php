 ...
 */
namespace ISN\PaymentAccount\Test\Unit\Plugin\Sales\Model\Order\Payment\Operations;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;
use ISN\PaymentAccount\Plugin\Sales\Model\Order\Payment\Operations\RemoveCaptureCommentsPlugin;
...
class RemoveCaptureCommentsPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->removeCaptureCommentsPlugin = $this->objectManagerHelper->getObject(
            \ISN\PaymentAccount\Plugin\Sales\Model\Order\Payment\Operations\RemoveCaptureCommentsPlugin::class,
            []
        );
    }
    ...
    public function testAroundCapture()
    {
        ...
        $this->paymentMock->expects($this->atLeastOnce())->method('getMethod')
            ->willReturn(AccountPaymentPaymentConfigProvider::METHOD_NAME);
    ...
    /**
     * Test for aroundCapture() method if payment method is not 'accountpayment'.
     *
     * @return void
     */
    public function testAroundCaptureIfMethodNotAccountPayment()
    {
        $invoice = null;
