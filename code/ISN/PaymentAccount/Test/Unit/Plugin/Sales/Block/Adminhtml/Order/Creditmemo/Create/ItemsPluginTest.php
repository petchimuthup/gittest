...
namespace ISN\PaymentAccount\Test\Unit\Plugin\Sales\Block\Adminhtml\Order\Creditmemo\Create;
...
{
    /**
     * @var \ISN\PaymentAccount\Plugin\Sales\Block\Adminhtml\Order\Creditmemo\Create\ItemsPlugin
     */
    private $itemsPlugin;
    ...
    protected function setUp()
    {
        ...
        $this->itemsPlugin = $objectManager->getObject(
            \ISN\PaymentAccount\Plugin\Sales\Block\Adminhtml\Order\Creditmemo\Create\ItemsPlugin::class
        );
    }
