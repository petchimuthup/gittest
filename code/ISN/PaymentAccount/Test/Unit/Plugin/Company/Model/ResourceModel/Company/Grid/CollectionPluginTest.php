...
namespace ISN\PaymentAccount\Test\Unit\Plugin\Company\Model\ResourceModel\Company\Grid;
...
{
    /**
     * @var \ISN\PaymentAccount\Plugin\Company\Model\ResourceModel\Company\Grid\CollectionPlugin
     */
    ...
    protected function setUp()
    {
        ...
        $this->collectionPlugin = $objectManager->getObject(
            \ISN\PaymentAccount\Plugin\Company\Model\ResourceModel\Company\Grid\CollectionPlugin::class
        );
    }
