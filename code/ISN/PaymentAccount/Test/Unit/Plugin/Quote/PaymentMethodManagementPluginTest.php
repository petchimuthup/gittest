...
namespace ISN\PaymentAccount\Test\Unit\Plugin\Quote;
...
class PaymentMethodManagementPluginTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Plugin\Quote\PaymentMethodManagementPlugin
     */
    ...
    protected function setUp()
    {
        ...
        $this->paymentMethodManagementPlugin = $objectManager->getObject(
            \ISN\PaymentAccount\Plugin\Quote\PaymentMethodManagementPlugin::class,
            [
