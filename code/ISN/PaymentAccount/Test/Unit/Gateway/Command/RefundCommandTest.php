 ...
 */
namespace ISN\PaymentAccount\Test\Unit\Gateway\Command;
...
class RefundCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Gateway\Command\RefundCommand
     */
    private $refundCommand;

    /**
     * @var \ISN\PaymentAccount\Model\CreditBalance|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    {
        $this->creditBalance = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditBalance::class)
        ...
        $this->refundCommand = $this->objectManagerHelper->getObject(
            \ISN\PaymentAccount\Gateway\Command\RefundCommand::class,
            [
