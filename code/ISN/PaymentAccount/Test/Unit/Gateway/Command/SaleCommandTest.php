...
class SaleCommandTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Gateway\Command\SaleCommand
     */
    private $saleCommand;
    ...
    public function setUp()
    {
        $this->configInterfaceMock = $this->getMockBuilder(\Magento\Payment\Gateway\ConfigInterface::class)
            ...
            ->getMock();
        $this->creditBalanceMock = $this->getMockBuilder(\ISN\PaymentAccount\Model\CreditBalance::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->saleCommand = $this->objectManagerHelper->getObject(
            \ISN\PaymentAccount\Gateway\Command\SaleCommand::class,
            [
