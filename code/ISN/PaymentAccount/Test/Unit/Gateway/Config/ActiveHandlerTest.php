 ...
 */
namespace ISN\PaymentAccount\Test\Unit\Gateway\Config;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManagerHelper;

/**
 * Unit tests for \ISN\PaymentAccount\Gateway\Config\ActiveHandler.
 */
class ActiveHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Gateway\Config\ActiveHandler
     */
    ...
    public function setUp()
    {
        ...
        $this->activeHandler = $this->objectManagerHelper->getObject(
            \ISN\PaymentAccount\Gateway\Config\ActiveHandler::class,
            [
