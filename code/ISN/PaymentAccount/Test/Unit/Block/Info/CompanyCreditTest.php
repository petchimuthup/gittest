...
namespace ISN\PaymentAccount\Test\Unit\Block\Info;

/**
 * Class AccountPaymentTest.
 */
class AccountPaymentTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    /**
     * @var \ISN\PaymentAccount\Block\Info\AccountPayment
     */
    ...
    protected function setUp()
    {
        ...
        $this->accountPayment = $objectManager->getObject(
            \ISN\PaymentAccount\Block\Info\AccountPayment::class,
            [
    ...
    public function testGetChargedAmount()
    {
        ...
        $this->accountPayment->setData('info', $info);
        ...
        $this->assertEquals($expectedResult, $this->accountPayment->getChargedAmount());
    }
