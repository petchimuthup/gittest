...
namespace ISN\PaymentAccount\Test\Unit\Block\Adminhtml\Company\Edit;
...
{
    /**
     * @var \ISN\PaymentAccount\Api\Data\CreditLimitInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    private $creditLimit;
    ...
    /**
     * @var \ISN\PaymentAccount\Api\Data\CreditDataInterface|\PHPUnit_Framework_MockObject_MockObject
     */
    private $credit;
    ...
    /**
     * @var \ISN\PaymentAccount\Block\Adminhtml\Company\Edit\CreditBalance
     */
    ...
    protected function setUp()
    {
        ...
        $this->credit = $this->createMock(\ISN\PaymentAccount\Api\Data\CreditDataInterface::class);

        $objectManager = new \Magento\Framework\TestFramework\Unit\Helper\ObjectManager($this);
        $this->creditBalance = $objectManager->getObject(
            \ISN\PaymentAccount\Block\Adminhtml\Company\Edit\CreditBalance::class,
            [
