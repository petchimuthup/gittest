...
namespace ISN\PaymentAccount\Test\Unit\Controller\Adminhtml\Index;
...
class ReimburseTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Action\ReimburseFacade|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    /**
     * @var \ISN\PaymentAccount\Controller\Adminhtml\Index\Reimburse
     */
    private $reimburse;
    ...
    protected function setUp()
    {
        $this->jsonFactory = $this->getMockBuilder(\Magento\Framework\Controller\Result\JsonFactory::class)
            ...
            ->getMock();
        $this->reimburseFacade = $this->getMockBuilder(\ISN\PaymentAccount\Action\ReimburseFacade::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->reimburse = $objectManager->getObject(
            \ISN\PaymentAccount\Controller\Adminhtml\Index\Reimburse::class,
            [
