...
namespace ISN\PaymentAccount\Test\Unit\Controller\Adminhtml;
...
class AbstractActionTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\PaymentMethodStatus|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    protected function setUp()
    {
        ...
        $this->paymentMethodStatus = $this->createMock(
            \ISN\PaymentAccount\Model\PaymentMethodStatus::class
        );
        ...
        $this->action = $objectManagerHelper->getObject(
            \ISN\PaymentAccount\Controller\History\Index::class,
            [
    ...
    public function testExecute()
    {
        ...
        $this->authorization->expects($this->once())->method('isAllowed')
            ->with(\ISN\PaymentAccount\Controller\AbstractAction::COMPANY_CREDIT_RESOURCE)
            ->willReturn(true);
