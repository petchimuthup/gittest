...
namespace ISN\PaymentAccount\Block\Link;
...
class Delimiter extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \ISN\PaymentAccount\Model\PaymentMethodStatus
     */
    private $paymentMethodStatus;

    /**
     * AccountPaymentLink constructor.
     *
     * @param \Magento\Framework\View\Element\Template\Context $context
     * @param \Magento\Company\Model\CompanyContext $companyContext
     * @param \ISN\PaymentAccount\Model\PaymentMethodStatus $paymentMethodStatus
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Magento\Company\Model\CompanyContext $companyContext,
        \ISN\PaymentAccount\Model\PaymentMethodStatus $paymentMethodStatus,
        array $data = []
    ) {
