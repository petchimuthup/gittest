...
namespace Tychons\Quickrfq\Controller\Adminhtml\Index;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Tychons\Quickrfq\Model\Quickrfq');
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Tychons_Quickrfq::quickrfq')
    ...
    {
        return $this->_authorization->isAllowed('Tychons_Quickrfq::quickrfq');
    }
}
